...
export const CORE_OPEN_PROJECT = 'core:open.project'
export const CORE_CLOSE_PROJECT = 'core:close.project'

export const CORE_GET_FILE_TYPE = 'core:get.file-type'
export const CORE_CREATE_FOLDER = 'core:create.folder'
export const CORE_OPEN_FILE = 'core:open.file'
export const CORE_SAVE_FILE = 'core:save.file'
export const CORE_RENAME_FILE = 'core:rename.file'
export const CORE_REMOVE_FILE = 'core:remove.file'
export const CORE_REMOVE_FOLDER = 'core:remove.folder'
